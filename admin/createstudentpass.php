...
<br><br><br>
  ...
  <div class="add-container">
    <form class="logIn" action="createstudentpass.php" id="createpass_form" method="post">

      <?php echo display_error();?>

      <input type="hidden" name="uid" value="<?php echo $_SESSION['studid'];?>">      
      ...
      <input aria-disabled="false" type="submit" value="Create" name="studPass_btn" id="addcourse">
    </form>
  </div>
