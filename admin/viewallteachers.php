...
<html lang="en">
  <head>
    <!-- Required meta tags -->
    <title>View all teachers page</title>
    <meta charset="utf-8">
  ...
  <div class="site-logo">
    ...
    <div class="left-nav">
      ...
      <div class="menu">
        ...
        <a href="viewallteachers.php?logout='1'">Log Out</a>
      </div>
    </div>
    <?php endif ?>
  </div>   
...
<h1><strong>Active Teachers</strong></h1>
</div>
...
<div class="table">
    ...
    <table id="table" style="text-align: center; width: 90%; margin: auto;" cellspacing="3" cellpadding="10" id="table">
        ...
        <tbody>
            <?php echo viewAllTeachersInfo();?>
        </tbody>
        <tfoot></tfoot>
    </table>
    <p>
        <a href="addnewteacher.php"><button name="addteacher_btn">Add</button></a>
    </p>
</div>
<div class="footer">
