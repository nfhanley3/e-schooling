  ...
  include 'updatestudents.php';
    ...
    # code...
        ...
        # code...
            ...
            $result =
            $mysqli->query("SELECT * FROM studenttable WHERE studentID = '$studentID'");

            if (mysqli_num_rows($result) > 0) {
                list($prefix, $studentID, $firstName, $lastName, $middleName, $phone, $gender, $race, $dateOfBirth, $streetName, $apart_no, $city, $states, $zipCode) = $result->fetch_array();
            // sessions
...
<div class="wrapper">
  ...
  <form action="editstudent.php" method="POST" class="form_container">
  <fieldset>
...
<td>
    <input placeholder="Zip Code" type="text" id="zipcode" name="zipcode" maxlength="10" autocomplete="off" value="<?php echo $_SESSION['z_code'] ?>">
</td>
</tr>
<tr>
  <td>
...
<tr>
  <td>
    <input type="submit" name="s_update" value="Update Now" id="sub_btn">
</td>
<td></td>
<td>
...
<p id="backtoblog" style="margin-top: 10px;">
  <a href="viewallstudents.php">&leftarrow; Back to students page</a>
</p>
</div>
