<?php
    require_once 'createnewstudent.php';
...
<head>
<meta charset="utf-8">
<title>Create A New Students Account Page</title>
  ...
  <div class="site-logo">
    ...
    <div class="left-nav">
      ...
      <div class="menu">
        ...
        <a href="addnewstudent.php?logout='1'">Log Out</a>
      </div>
    </div>
    <?php endif ?>
  </div>   
...
<div class="wrapper">
  <form action="addnewstudent.php" method="POST" class="form_container">
    <fieldset>
      ...
      <table>
        ...
        <tr>
          ...
          <td>
            <input placeholder="Zip Code" type="text" id="zipcode" value="" name="zipcode" pattern="[0-9]*" maxlength="5" autocomplete="off" value="<?= isset($_POST['zipcode']) ? htmlspecialchars($_POST['zipcode']) : '' ?>">
          </td>
        </tr>
        <tr>
          <td>
        ...
        <tr>
          ...
          <tr>
            <td>
              <input type="submit" name="createStud" value="Create" id="sub_btn">
            </td>
            <td></td>
            <td>
