...
echo "<html>\n";
echo "<head>\n";
echo "	<title>Teacher Portal</title>\n";
echo "<br/>\n";
echo "	<link rel = \"stylesheet\" href=\"teacherportal.css\" type=\"text/css\" />\n";
echo "\n";
echo "</head>\n";
echo "\n";
echo "<body>\n";
...
echo "\n";
echo "\n";
echo "		<h1><strong>Teacher Portal</strong></h1>\n";
echo "                    <center><img src=\"F:imagesN7.png\" width=\"150px\" height=\"150\">           <img src=\"F:imagesn13.png\" width=\"150px\" height=\"150\"></center>\n";
echo "		    \n";
echo "\n";
echo "\n";
